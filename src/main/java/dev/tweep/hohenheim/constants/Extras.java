...
public final class Extras {
    ...
    static {
        ...
        TRANSMUTATION_MENU_ITEM = new CustomItemStack(Material.GOLDEN_APPLE, ChatColor.DARK_RED + "Transmutation Items");

        HERBOLOGY_CATEGORY_KEY = new NamespacedKey(Hohenheim.getInstance(), "herbology_category_key");
        HERBOLOGY_MENU_ITEM = new CustomItemStack(Material.ROSE_BUSH, ChatColor.GREEN + "Herbology Items");

        TRANSMUTATION_WAND_KEY = new NamespacedKey(Hohenheim.getInstance(), "transmutation_wand_recipetype");
        TRANSMUTATION_WAND_RECIPE_ITEM = new CustomItemStack(Material.STICK, ChatColor.DARK_RED + "Transmutation Wand",
